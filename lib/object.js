...
inherits(ObjectSchema, MixedSchema, {
  ...
  _cast(_value, options = {}) {
    let value = MixedSchema.prototype._cast.call(this, _value, options); //should ignore nulls here
  ...
  _validate(_value, opts = {}) {
    ...
    return MixedSchema.prototype._validate.call(this, _value, opts).catch(propagateErrors(endEarly, errors)).then(value => {
