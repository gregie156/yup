...
const proto = SchemaType.prototype = {
  ...
  concat(schema) {
    ...
    next._whitelist = this._whitelist.union(schema._whitelist).setminus(schema._blacklist);
    next._blacklist = this._blacklist.union(schema._blacklist).setminus(schema._whitelist); // manually add the new tests to ensure
  ...
  resolve(options) {
    if (this._conditions.length) {
      return this._conditions.reduce((schema, condition) => condition.resolve(schema, options), this);
    }
